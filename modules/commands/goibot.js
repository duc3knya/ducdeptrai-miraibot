...
module.exports.handleEvent = function({ api, event }) {
  ...
  if ((event.body.toLowerCase() == "bot ngu")) {
    return api.sendMessage("Thành viên đã cố ý chửi bot, do đó đã vi phạm luật bot nên bot sẽ out và muốn add lại thì xin liên hệ qua admin qua Fb:Lê Năng Hoàng Đức để được hỗ trợ\nLink fb nè: https://www.facebook.com/Mark.Zuckerberg2405", threadID, () =>
  ...
  if ((event.body.toLowerCase() == "anh Đức") || (event.body.toLowerCase() == "anh Duc")) {
  ...
  if ((event.body.toLowerCase() == "a Đức") || (event.body.toLowerCase() == "a Đức")) {
    return api.sendMessage("Anh ấy tuy ko đẹp trai hay giỏi gì nhưng được cái hài hước và luôn mong đạt được mục tiêu anh ấy muốn <3 <3 ", threadID);
  };

  if ((event.body.toLowerCase() == "Đức") || (event.body.toLowerCase() == "Duc")) {
    return api.sendMessage("Anh ấy tuy ko đẹp trai hay giỏi gì nhưng được cái hài hước và luôn mong đạt được mục tiêu anh ấy muốn <3 <3 ", threadID);
  };
  ...
  if ((event.body.toLowerCase() == "admin m là ai v bot") || (event.body.toLowerCase() == "admin m la ai v bot")) {
    return api.sendMessage("️Admin tao Lê Năng Hoàng Đức -ad hoặc -adm để biết thêm chi tiết", threadID);
  };

  if ((event.body.toLowerCase() == "admin m là ai vậy bot") || (event.body.toLowerCase() == "admin m la ai vậy bot")) {
    return api.sendMessage("️Admin tao Lê Năng Hoàng Đức có gì dùng lệnh /ad hoặc /adm để biết thêm chi tiết", threadID);
  };
  ...
  if ((event.body.toLowerCase() == "ông Đức") || (event.body.toLowerCase() == "ong Dang")) {
    return api.sendMessage("️Kêu chủ của tôi gì á :)?", threadID);
  };

  if ((event.body.toLowerCase() == "ôg Đức") || (event.body.toLowerCase() == "og Dang")) {
